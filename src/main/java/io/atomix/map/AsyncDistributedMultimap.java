...
import io.atomix.map.impl.BlockingDistributedMultimap;
import io.atomix.set.AsyncDistributedMultiset;
...
public interface AsyncDistributedMultimap<K, V> extends AsyncPrimitive<AsyncDistributedMultimap<K, V>, DistributedMultimap<K, V>> {
     ...
     */
    default CompletableFuture<Cancellable> listen(MultimapEventListener<K, V> listener) {
