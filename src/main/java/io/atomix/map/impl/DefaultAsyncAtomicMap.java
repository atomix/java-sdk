...
import io.atomix.api.map.v1.InsertRequest;
import io.atomix.api.map.v1.LockRequest;
import io.atomix.api.map.v1.MapGrpc;
import io.atomix.api.map.v1.PutRequest;
import io.atomix.api.map.v1.RemoveRequest;
import io.atomix.api.map.v1.SizeRequest;
import io.atomix.api.map.v1.SizeResponse;
import io.atomix.api.map.v1.UnlockRequest;
import io.atomix.api.map.v1.UpdateRequest;
import io.atomix.api.map.v1.VersionedValue;
