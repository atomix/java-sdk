 ...
 * </p><p>
 * All values stored in this map are #FIXME We need to implement the substitute of Versioned
 * and the API supports optimistic concurrency by allowing conditional updates that take into
...
public interface AsyncAtomicMap<K, V> extends AsyncPrimitive {
    ...
    // FIXME temporary disabled. We need to implement
    //  the substitute of AsyncDistributedSet
    /**
    ...
    // FIXME temporary disabled. We need to implement
    //  the substitute of Versioned and AsyncDistributedCollection
    /**
    ...
    // FIXME temporary disabled. We need to implement
    //  the substitute of Versioned and AsyncDistributedSet
    /**
